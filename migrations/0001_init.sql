-- Schema for the scuttlebutt dashboard (Neon / Postgres).
-- Paste this into the Neon SQL editor, or run with psql against your
-- DATABASE_URL. One row per person we might reach out to about a company.
